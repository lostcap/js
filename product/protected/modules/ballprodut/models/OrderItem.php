...
class OrderItem extends CActiveRecord {
    ...
    public function relations() {
        ...
        return array(
            'product' => array(self::BELONGS_TO, 'ProductCollection', 'item_product_id'),
            'attribute' => array(self::BELONGS_TO, 'OrderAttribute', 'item_attribute_id'),
    ...
    public function getPrice($sign){
        return $sign.$this->item_price;
    }
