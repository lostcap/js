...
<h2>订单查找</h2>
 ...
 <?php
    ...
    <p>
        输入你想要查找的订单号，比如订单号：(LQLV098)293882711183,那么所搜索的订单号应该是： 293882711183 。
    </p>
    <br>
    <tr>
        <td class="label">订单号：<span class="required">*</span></td>
        <td class="value"><?php echo CHtml::textField('invoice','',array('style'=>'margin-bottom: 0px;')); ?></td>
...
if ($invoice) {
    ...
    $this->widget('bootstrap.widgets.BootGridView', array(
        'id' => 'order-grid',
        'dataProvider' => $model->orderSearch($invoice),
